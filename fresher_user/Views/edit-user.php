                ...
                <div class="block-fluid">
                    <form method="post">
                        <div class="row-form">
                            ...
                            <div class="span9"><input type="text" value="<?php echo $row['username']?>" name="txtusername"/></div>
                            <div class="clear"></div>
                        </div>
                        <div class="row-form">
                            <div class="span3">Email:</div>
                            <div class="span9"><input type="text" value="<?php echo $row['user_email']?>" name="txtemail"/></div>
                            <div class="clear"></div>
                        </div>
                        <div class="row-form">
                            <div class="span3">Password:</div>
                            <div class="span9"><input type="text" placeholder="some text value..." name="txtpass"/></div>
                            <div class="clear"></div>
                        </div>
                        <div class="row-form">
                            <div class="span3">Upload Avatar:</div>
                            <div class="span9">
                                <img src="TemplatePHP/img/users/avatar.jpg" /><br/>
