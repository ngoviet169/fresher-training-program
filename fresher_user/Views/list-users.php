...
<div class="menu">
    ...
    <div class="breadLine">
        ...
        <div class="adminControl active">
            <?php echo 'You are loged in with ' . $_SESSION['username']; ?>
        </div>
    </div>
                            ...
                            foreach ($result as $key => $value)
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><span class="text-success"><?php echo ($value['status']==1) ? 'Actived' : 'Not Active'; ?></span></td>
                                        <td><?php echo $value['user_time_created'] ?></td>
                                        <td><?php echo $value['user_time_updated'] ?></td>
                                        <td><a href="index.php?controller=UserController&action=editUser&id=<?php echo $value['user_id'] ?>" class="btn btn-info">Edit</a></td>
                                        <td><a href="index.php?controller=UserController&action=deactiveUser&id=<?php echo $value['user_id'] ?>" class="btn btn-info">Deactive</a></td>
                                    </tr>
                                <?php
                                }
                        ?>
